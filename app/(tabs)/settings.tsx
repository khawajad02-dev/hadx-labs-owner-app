                ...
                <View style={[styles.presetCard, { backgroundColor: colors.surface, borderColor: selected ? colors.primary : colors.border }]}>
                  ...
                  <View style={styles.presetCopy}>
                    ...
                    <Text style={[styles.presetMeta, { color: selected ? colors.primary : colors.muted }]}>
                      {theme.id === "bento-telemetry" ? "BENTO GRID / MODULAR" : theme.id === "visionos-spatial" ? "SPATIAL GLASS / FLOATING" : theme.id === "cyberpunk-terminal" ? "TERMINAL / EVENT STREAM" : theme.id === "neumorphic-luxe" ? "TACTILE / SOFT DEPTH" : theme.id === "liquid-monogram" ? "LIQUID GLASS / HADX MARK" : "OBSIDIAN / CYBER CORE"}
                    </Text>
                  </View>
                </View>
              </Pressable>
